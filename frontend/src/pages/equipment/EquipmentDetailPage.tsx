...
// Already delegates its check rows to EquipmentCheckRow and its edit form to
  ...
  return (
    <div className="max-w-3xl">
      ...
      <CheckHistoryList
        ...
        renderCheck={(check) => <EquipmentCheckRow check={check} />}
        path={CHECKS_PATH}
...
function EquipmentCheckRow({ check }: { check: Row }) {
  return (
